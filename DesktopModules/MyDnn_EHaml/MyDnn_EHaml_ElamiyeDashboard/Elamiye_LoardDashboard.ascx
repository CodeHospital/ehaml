<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Elamiye_LoardDashboard.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_ElamiyeDashboard.Elamiye_LoardDashboard" %>
...
<%--<div class="LordDashboard-Form dnnForm">
    ...
    <div class="dnnFormItem">
        <dnn:Label ID="lblActiveElamiye"Text="اعلامیه ها"></dnn:Label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: sf0.getServiceRoot('MyDnn_EHaml_Inquiries') + "Dashboard/GetGrideMoredeNazarVaseDashboardElamiyeSaheb",
    ...
    function bindGrdMyElamiyesSucS(myInquirysList) {
        ...
        $("#grdMySucElamiyes").kendoGrid({
            ...
            columns: [
                ...
                {
                    title: "اطلاعات اعلامیه",
                    field: "Id",
                    width: "30px",
                    template:
                        function(dataItem) { return "<div><span class='ShomareEstelam'>شماره اعلامیه: " + dataItem.Id + "</span><span class='CreateDateSuc'>تاریخ تایید: " + dataItem.CreateDate + "</span><span class='StartingPointSuc'>مبدا: " + dataItem.StartingPoint + "</span><span class='JoziyateEstelamSSuc'>جزئیات: " + dataItem.JoziyateAsli + "</span></div>" }
                    //function(dataItem) { return "<div><span class='ShomareEstelam'>شماره اعلامیه: " + dataItem.Id + "</span><span class='CreateDateSuc'>تاریخ تایید: " + dataItem.CreateDate + "</span><span class='StartingPointSuc'>(" + dataItem.StartingPoint + ") به (" + dataItem.Destination + ")</span><span class='JoziyateEstelamSSuc'><a href='javascript:void(0)' class='k-button k-button-icontext' onclick='JoziyateElamiyeS(\"" + dataItem.JoziyatLink + "\")'>جزئیات اعلامیه</a></span></div>" }
                },
                {
                ...
                //                return "<span class='ShomaGablanSherkatKadeed'><a href='javascript:void(0)' onclick='NazarSanjiSahebBeKhadamatElamiye(" + dataItem.ERTEID + ")' class='k-button k-button-icontext'>شرکت در نظر سنجی</a></span>";
                //            } else {
    ...
    function bindGrdMyElamiyesS(myElamiyesList) {
        $("#grdMyElamiyesS").kendoGrid({
            ...
            columns: [
                { title: "ردیف", field: "Id", width: "25px" },
                ...
                { title: "نوع اعلامیه", field: "ElamiyeType", width: "27px" },
                { title: "وسیله", field: "Vasile", width: "90px" },
                {
                    title: "زمان آمادگی",
                    field: "ZamaneAmadegi",
                    width: "27px",
                ...
                { title: "نوع علامیه", field: "ElamiyeTypeEN", width: ".01px" },
                ...
                //            }
                //    },
                //    { title: "شماره اعلامیه", field: "Id", width: "55px" },
                //    {
                //        title: "جزئیات اعلامیه",
                //        field: "Id",
                //        width: "55px",
                //        template:
                //            function(dataItem) {
    ...
    function bindGrdMyElamiyesTarikhGozashteS(myElamiyesList) {
        $("#grdMyElamiyesTarikhGozashte").kendoGrid({
            ...
            columns: [
                ...
                { title: "نوع علامیه", field: "ElamiyeType", width: "27px" },
                { title: "وسیله", field: "Vasile", width: "90px" },
                {
                    title: "زمان آمادگی",
                    field: "ZamaneAmadegi",
    ...
    function bindMyElamiyeReplyListStep2S(myElamiyesReply) {
        $("#grdMyElamiyesReply").kendoGrid({
            ...
            columns: [
                { title: "ردیف", field: "rtelID", width: "6px" },
                {
                    title: "اطلاعات صاحب بار",
                    field: "Power",
                    width: "20px",
                ...
                },
                {
                    ...
                    width: "47px",
                    template:
                        function(dataItem) { return "<div><span class='masir'>" + dataItem.Masir + "</span><span class='vasilemoredeniyazesm'>وسیله مورد نیاز: " + dataItem.VasileyeHaml + "  " + dataItem.Tedad + " دستگاه </span><span class='ZamaneAmadegiBarayeShooroo'>زمان نیاز به حمل: " + dataItem.zaman + "</span><span class='TarikheErsal'>تاریخ ارسال: " + dataItem.CreateDate + "</span></div>" }
                    ...
                    template:
                        function(dataItem) {
                            if (dataItem.VaziyatePaziresh == "1") {
                                ...
                                return "<div><span class='BaPishnahadMovafegam amaliyat'><a class='k-button k-button-icontext' <a href='javascript:void(0)' onclick='BaPishnahadMovafeghamS(" + dataItem.ERTEID + ',' + dataItem.elaId + ',' + '"' + dataItem.typeela + '"' + ")'>با این پیشنهاد موافقم</a></span></div>";
                            } else {
            ...
            //{ title: "وسیله مورد نیاز", field: "VasileyeMoredeNiyaz", width: "16px" },
            //{
            //    title: "جزئیات",
            //    field: "Id",
            //    width: "19px",
        ...
        $(".ZamaneAmadegiBarayeShooroo").each(function() {
            ...
            //var month = dt2.substr(5, 2);
            //var day = dt2.substr(7, 2);
            $(this).text("زمان نیاز به حمل: " + (ToPersianDate(myDate)));
        });
    }
