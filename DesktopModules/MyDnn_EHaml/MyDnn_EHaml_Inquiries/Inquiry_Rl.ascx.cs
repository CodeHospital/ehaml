...
{
    public partial class Inquiry_Rl : PortalModuleBase
    {
        ...
        private void lnkPrintKon_Click(object sender, EventArgs e)
        {
            Response.Redirect("/default.aspx?tabid=" + this.TabId + "&mid=" + this.ModuleId +
                              "&ctl=ReplyToInquiry_Rl&InqId=" + hiddenFieldId.Value + "&popUp=true&IsPrint=Yes");
        }
        ...
        private void lnkSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MyDnn_EHaml_Inquiry_Rl Rl = new MyDnn_EHaml_Inquiry_Rl();

                    if (fupFormeListeAdlBandiFull.HasFile)
                    {
                        Rl.FileListAdlBandi = UploadFormFileAdlBandi(fupFormeListeAdlBandiFull);
                    }
                    Rl.VagoneMoredeNiyaz = cbolVagoneMoredeNiyaz.SelectedItem.Value;

                    Rl.IsHazineyeBargiriDarMabda = chkIsBargiriDarMabda.Checked;
                    Rl.EmptyingCharges = chkIsTakhliyeDarMagsad.Checked;
                    ...
                    context.MyDnn_EHaml_Inquiry_Rls.InsertOnSubmit(Rl);
                    ...
                    inquiry.InquiryDetail_Id = Rl.Id;
        ...
        private string UploadFormFileAdlBandi(FileUpload uploadedFile)
        {
            ...
            string fileName = "Rl_AdlBandi_UId(" + this.UserId + ")_" + guid.Substring(0, 8) +
                              ".xlsx";
            ...
            //string now = DateTime.Now.ToShortDateString().Replace('\\', '_');
            string fileName2 = "Rl_AdlBandi_UId(" + this.UserId + ")_" + guid.Substring(0, 8) +
                               ".xlsx";
        ...
        private void FillPageControlls()
        {
            ...
            FillcbolVagoneMoredeNiyaz();
            //FillCbolDestinationOstan();
            FillCbolStartingPointOstan();
        }

        private void FillcbolVagoneMoredeNiyaz()
        {
            cbolVagoneMoredeNiyaz.Items.Add(new DnnComboBoxItem("مسقف", "مسقف"));
            cbolVagoneMoredeNiyaz.Items.Add(new DnnComboBoxItem("لبه دار کوتاه", "لبه دار کوتاه"));
            cbolVagoneMoredeNiyaz.Items.Add(new DnnComboBoxItem("لبه دار بلند", "لبه دار بلند"));
        }
