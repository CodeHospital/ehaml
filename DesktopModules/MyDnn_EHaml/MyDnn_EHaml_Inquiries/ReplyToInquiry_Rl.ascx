<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplyToInquiry_Rl.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.ReplyToInquiry_Rl" %>
...
<asp:Panel runat="server" ID="pnlMessageForNotApprovedAfterErsal" Visible="False"><div class="MessageAfterErsal"><p>لینک فعال سازی حساب کاربری شما به ایمیل تان ارسال گردید. لطفآ ایمیل خود را بررسی نمایید.</p></div></asp:Panel><asp:Panel runat="server" ID="pnlMessageForNotApproved" Visible="False">
                                                                                                                                                                                                                                      <div class="MessageForNotApproved">
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          <asp:LinkButton runat="server" ID="btnErsaleLinkTaeid14" Text="ارسال مجدد لینک تایید"/>
                                                                                                                                                                                                                                      </div>
                                                                                                                                                                                                                                  </asp:Panel>
<div class="ReplyToInquiry-Rl-Shenasname dnnForm shenasnameForm">
    <div class="dnnFormItem pasokh-title">
        <dnn:Label Text="شناسنامه استعلام" ID="lblReplyToInquiryTkShenasnameTitle" runat="server"></dnn:Label>
    </div>
    ...
    <div class="dnnFormItem">
        <dnn:Label HelpText=" " ID="lblVagoneMoredeNiyazSh" Text="نوع واگن مورد نیاز:" runat="server"></dnn:Label>
        <dnn:Label  ID="lblVagoneMoredeNiyazShValue" runat="server"></dnn:Label>
    </div>
    ...
    <div class="dnnFormItem">
        <dnn:Label HelpText=" " ID="lblIsHazineyeBargiriDarMabdaSh" Text="با احتساب هزینه بارگیری در مبدا:" runat="server"></dnn:Label>
        <dnn:Label  ID="lblIsHazineyeBargiriDarMabdaShValue" runat="server"></dnn:Label>
    </div>
    
    <div class="dnnFormItem">
        <dnn:Label HelpText=" " ID="lblEmptyingCharges" Text="با احتساب هزینه تخلیه در مقصد:" runat="server"></dnn:Label>
...
<div class="ReplyToInquiry-Rl-Reply-Form dnnForm formPasokh" style="display: none">
    <div class="dnnFormItem pasokh-title">
        <dnn:Label  ID="lblReplyToInquiryTkTitle" runat="server" Text="پاسخ به استعلام"></dnn:Label>
    </div>
    <div class="dnnFormItem" style="display: none">
    ...
    <div class="dnnFormItem">
        <dnn:Label ID="Label1" runat="server" Text="با احتساب هزینه بارگیری در مبداء" HelpText=" "></dnn:Label>
        <asp:CheckBox Text="با احتساب هزینه بارگیری در مبداء" runat="server" ID="chkIsBargiriDarMabda"/>
    </div>
    <div class="dnnFormItem">
        <dnn:Label ID="Label4" runat="server" Text="با احتساب هزینه تخلیه در مقصد" HelpText=" "></dnn:Label>
    ...
    <div class="dnnFormItem">
        <span class="full-line textAfterTheButton">(کلیه هزینه های تعویض ریل و هزینه های مرزی –غیر از ترخیص کالا- در قیمت لحاظ می باشد)</span>
    </div>
...
<script>
    ...
    function CalcultePrice() {
        $(".geymateKol").val(mohasebegheymatForRAL());
    };
