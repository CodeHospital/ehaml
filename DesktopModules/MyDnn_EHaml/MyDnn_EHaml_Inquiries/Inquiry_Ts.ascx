<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Inquiry_Ts.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.Inquiry_Ts" %>
...
<div class="InquiryTs-Form dnnForm">
    <div class="dnnFormItem">
        <dnn:label id="lblInquiryTsTitle" runat="server"></dnn:label>
    </div>
    ...
    <div class="dnnFormItem">
        ...
        <dnn:DnnComboBox EmptyMessage="-- انتخاب نماييد --" runat="server" id="cbolNoeAmaliyat" />
                        <asp:RequiredFieldValidator ValidationGroup="FormValidation" ID="RequiredFieldValidator2"
                                    CssClass="dnnFormMessage dnnFormError"
                                    runat="server" Display="Dynamic" ControlToValidate="cbolNoeAmaliyat"
                                    resourcekey="ErrorMessage" />
    </div>

    <div class="dnnFormItem fromtop20">
        <dnn:label helptext=" " text="کشور محل عملیات:" cssclass="dnnFormRequired" runat="server" id="lblStartingPointOstanA" />
    ...
    <div class="dnnFormItem">
        <dnn:label text="شهر محل عملیات:" helptext=" " cssclass="dnnFormRequired" runat="server" id="lblStartingPointShahrA" />
    ...
    <div class="InquiryTs-Form-ListeAdlBandi dnnFormItem" style="margin-bottom: 20px">
        <dnn:label helptext=" " cssclass="dnnFormRequired" runat="server" text="فرم لیست عدل بندی:"></dnn:label>
    ...
    <div class="InquiryDghco-Form-ListeAdlBandi dnnFormItem" style="margin-bottom: 20px">
        ...
        <div class="dnnFormItem fromtop20">
            <dnn:label helptext=" " text="محل تخلیه(بارگیری):" id="lblMakaneAmaliyat" cssclass="dnnFormRequired" runat="server"></dnn:label>
            <dnn:DnnComboBox EmptyMessage="-- انتخاب نماييد --" runat="server" id="cbolMakaneAmaliyat" />
            <asp:RequiredFieldValidator ValidationGroup="FormValidation" ID="RequiredFieldValidator5" CssClass="dnnFormMessage dnnFormError"
                                            runat="server" Display="Dynamic" ControlToValidate="cbolMakaneAmaliyat" resourcekey="ErrorMessage" />
        </div>

        <div class="dnnFormItem">
                <dnn:label cssclass="dnnFormRequired" helptext=" " runat="server" text="تاریخ شروع عملیات:" id="lblActionDate" />
        ...
        <div class="dnnFormItem">
            <ul class="dnnActions dnnClear">
                <li>
                    <asp:LinkButton ID="lnkSubmit" OnClientClick="DisableHiddenValidators()" Text="ارسال:" ValidationGroup="FormValidation" runat="server" CssClass="dnnPrimaryAction" resourcekey="lnkSubmit" />
                </li>
            </ul>
        </div>
    </div>
