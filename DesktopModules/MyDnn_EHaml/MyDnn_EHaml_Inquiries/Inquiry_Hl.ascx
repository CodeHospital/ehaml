<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Inquiry_Hl.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.Inquiry_Hl" %>
...
<script>
    ...
    function onClickNeshoonDadaneFileArzesheBar() {
        var checked1 = $(".dnnformItem .chkIsBaEhtesabeAkhseTarkhisiyeDarMabda input").is(":checked");
        var checked2 = $(".dnnformItem .chkIsBaEhtesabeAkhseTarkhisiyeDarMagsad input").is(":checked");
        if (checked1 || checked2) {
            $(".fileArzeshebar").fadeIn(200);
        } else {
            $(".fileArzeshebar").fadeOut(200);
        }
    }
...
<asp:Panel runat="server" ID="pnlMessageForBedehkarUser" Visible="False">
    <div class="MessageForBedehkarUser">
        ...
        <a href="/default.aspx?tabid=<%= PortalController.GetPortalSettingAsInteger("TasviyeTabId", PortalId, -1) %>
            &type=1&FinalReturnTabId=<%= this.TabId %>">تسویه حساب</a>
    </div>
</asp:Panel>
...
<div class="InquiryDn-Form dnnForm hlForm">
    ...
    <div class="dnnFormItem">
        ...
        <div style="float: left;"> <div style="margin-right: 26%;"><dnn:Label CssClass="textAfterTheButton tosiye" Text="توصیه میشود تکمیل نمایید" runat="server" ></dnn:Label></div></div>

        <div class="dnnFormItem">
            <dnn:label text="کشور مبدا(قابل تایپ):" helptext=" " runat="server" id="lblStartingPointOstan2" cssclass="dnnFormRequired" />
        ...
        <div class="dnnFormItem">
            <dnn:label runat="server" text="با احتساب هزینه ترخیص در مبدا" helptext=" "></dnn:label>
            <asp:CheckBox CssClass="chkIsBaEhtesabeAkhseTarkhisiyeDarMabda" runat="server" Text="با احتساب اخذ ترخیصیه در مقصد" ID="chkIsBaEhtesabeAkhseTarkhisiyeDarMabda" />
            <%--<asp:CheckBox CssClass="chkIsBaEhtesabeAkhseTarkhisiyeDarMabda" onclick="onClickNeshoonDadaneFileArzesheBar()" runat="server" Text="با احتساب اخذ ترخیصیه در مقصد" ID="chkIsBaEhtesabeAkhseTarkhisiyeDarMabda" />--%>
        </div>
        <div class="dnnFormItem">
        ...
        <div class="dnnFormItem fileArzeshebar" style="display: none">
            <div class="dnnFormItem paneleVooroodeArzesheBar" style="margin-bottom: 20px;">
                <dnn:label runat="server" id="Label2" text="فرم ورود ارزش محموله" helptext="فرم ورود ارزش محموله" />
        ...
        <div class="dnnFormItem">
            ...
            <dnn:DnnComboBox EmptyMessage="-- انتخاب نماييد --" onclientselectedindexchanged=" FillShahrListMagsad " filter="Contains" cssclass="latinCombo" runat="server" id="cbolDestinationOstan"></dnn:dnncombobox>
        ...
        <div class="dnnFormItem">
            <dnn:label runat="server" text="با احتساب هزینه ترخیص در مقصد" helptext=" "></dnn:label>
            <asp:CheckBox CssClass="chkIsBaEhtesabeAkhseTarkhisiyeDarMagsad" runat="server" Text="با احتساب هزینه ترخیص در مقصد" ID="chkIsBaEhtesabeAkhseTarkhisiye" />
            <%--<asp:CheckBox onclick="onClickNeshoonDadaneFileArzesheBar()" CssClass="chkIsBaEhtesabeAkhseTarkhisiyeDarMagsad" runat="server" Text="با احتساب هزینه ترخیص در مقصد" ID="chkIsBaEhtesabeAkhseTarkhisiye" />--%>
        </div>
        <div class="dnnFormItem">
            ...
            <asp:RequiredFieldValidator ValidationGroup="FormValidation" ID="RequiredFieldValidator7" CssClass="dnnFormMessage dnnFormError"
                                        runat="server" Display="Dynamic" ControlToValidate="cbolMogeiyateTahvilGereftan" resourcekey="ErrorMessage" />
        </div>
