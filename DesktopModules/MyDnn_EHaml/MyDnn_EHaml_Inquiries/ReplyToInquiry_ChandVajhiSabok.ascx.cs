...
{
    public partial class ReplyToInquiry_ChandVajhiSabok : PortalModuleBase
    {
        ...
        private void lnkSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                        ...
                        new DataClassesDataContext(Config.GetConnectionString()))
                {
                    ...
                    MyDnn_EHaml_ReplyToInquiry_ChandVajhiSabok replyToInquiryChandVajhiSabok =
                        new MyDnn_EHaml_ReplyToInquiry_ChandVajhiSabok();
                    ...
                    replyToInquiryChandVajhiSabok.IsHazineyeOdat = chkIsOdateContinereKhali.Checked;
                    ...
                    context.MyDnn_EHaml_ReplyToInquiry_ChandVajhiSaboks.InsertOnSubmit(replyToInquiryChandVajhiSabok);
                    ...
                    replyToInquiry.ReplyToInquiryType = "ChandVajhiSabok";
        ...
        private void FillPageControllsShenasname(string inquiryId)
        {
                ...
                DataClassesDataContext context = new DataClassesDataContext(Config.GetConnectionString()))
            {
                ...
                MyDnn_EHaml_Inquiry_ChandVajhiSabok inquiryChandVajhiSabok =
                    (from i in context.MyDnn_EHaml_Inquiry_ChandVajhiSaboks
                ...
                lblOdatContinerValue.Text = inquiryChandVajhiSabok.IsHazineyeOdat.ToString();
