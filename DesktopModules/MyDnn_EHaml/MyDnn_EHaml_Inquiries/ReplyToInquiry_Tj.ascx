<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplyToInquiry_Tj.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.ReplyToInquiry_Tj" %>
...
<asp:Panel runat="server" ID="pnlMessageForNotApprovedAfterErsal" Visible="False"><div class="MessageAfterErsal"><p>لینک فعال سازی حساب کاربری شما به ایمیل تان ارسال گردید. لطفآ ایمیل خود را بررسی نمایید.</p></div></asp:Panel><asp:Panel runat="server" ID="pnlMessageForNotApproved" Visible="False">
                                                                                                                                                                                                                                      <div class="MessageForNotApproved">
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          <asp:LinkButton runat="server" ID="btnErsaleLinkTaeid1332" Text="ارسال مجدد لینک تایید"/>
                                                                                                                                                                                                                                      </div>
                                                                                                                                                                                                                                  </asp:Panel>
...
<div class="ReplyToInquiry-Dn-Reply-Form dnnForm formPasokh pasokhtj" style="display: none">
    <div class="dnnFormItem pasokh-title">
    ...
    <div class="dnnFormItem">
        <dnn:Label HelpText=" " cssclass="dnnFormRequired" ID="lblGeymatBarAsaseListAdlBandi" Text="قیمت کل بر اساس لیست عدل بندی:" runat="server" ></dnn:Label>
        <asp:TextBox CssClass="PriceItem_Groopaj_Geymat" ID="txtGeymatBarAsaseListAdlBandi" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" CssClass="dnnFormMessage dnnFormError" ValidationGroup="FormValidation" ControlToValidate="txtGeymatBarAsaseListAdlBandi" ErrorMessage="وارد کردن این فیلد الزامیست"></asp:RequiredFieldValidator>
    ...
    <div class="dnnFormItem">
        ...
        <asp:CompareValidator CssClass="dnnFormMessage dnnFormError" ValidationGroup="FormValidation" runat="server" ValueToCompare="-- انتخاب نماييد --" ControlToValidate="cbollblAnjameAmaliyatBeVasileye" ErrorMessage="وارد کردن این فیلد الزامیست"></asp:CompareValidator>
    ...
    <div class="dnnFormItem">
        ...
        <asp:RequiredFieldValidator CssClass="dnnFormMessage dnnFormError" runat="server" ValidationGroup="FormValidation" ControlToValidate="txtModatRooz" ErrorMessage="وارد کردن این فیلد الزامیست"></asp:RequiredFieldValidator>
    </div>
    ...
    <div class="dnnFormItem">
        ...
        <asp:RequiredFieldValidator CssClass="dnnFormMessage dnnFormError" runat="server" ValidationGroup="FormValidation" ControlToValidate="dtpZamaneAmadegiBarayeShoorooeAmaliyat" ErrorMessage="وارد کردن این فیلد الزامیست"></asp:RequiredFieldValidator>
    </div>
    ...
    <div class="dnnFormItem fromtop20">
        ...
        <asp:CompareValidator CssClass="dnnFormMessage dnnFormError" ValidationGroup="FormValidation" runat="server" ValueToCompare="-- انتخاب نماييد --" ControlToValidate="cbolPishbini" ErrorMessage="وارد کردن این فیلد الزامیست"></asp:CompareValidator>
    </div>
...
<script>
    ...
    function CalcultePrice() {
        $(".geymateKol").val(mohasebegheymatForTJ());
    }
