<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Inquiry_ChandVajhiSabok.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.Inquiry_ChandVajhiSabok" %>
...
<asp:Panel runat="server" ID="pnlMessageForNotApprovedAfterErsal" Visible="False">
    <div class="MessageAfterErsal"><p>لینک فعال سازی حساب کاربری شما به ایمیل تان ارسال گردید. لطفآ ایمیل خود را بررسی نمایید.</p></div>
</asp:Panel><asp:Panel runat="server" ID="pnlMessageForNotApproved" Visible="False">
...
<div class="Inquiry_ChandVajhiSabok-Form dnnForm">
<%--    <div class="dnnFormItem">
        <dnn:label id="lblInquiry_ChandVajhiSabokTitle" runat="server"></dnn:label>
    </div>
<%--    <div class="dnnFormItem">
...
<%--    <div class="Inquiry_ChandVajhiSabok-Form-ListeAdlBandi dnnFormItem">
    ...
    <div class="dnnFormItem">
        <asp:CheckBox runat="server" Text="تحویل به پیمانکار حمل بر اساس لیست عدلبندی" ID="chkIsTahvilBarAsaseListAdl"/>
    </div>
    <div class="dnnFormItem">
        <asp:CheckBox runat="server" Text="تحویل به پیمانکار حمل بر اساس نوع و تعداد کانتینر" ID="chkIsTahvilBarAsaseNoVaTedadeContiner"/>
    </div>
    <asp:Repeater ID="rptNoeContiner" runat="server">
        <ItemTemplate>
            <div class="dnnFormItem">
                <dnn:Label ID="lblContinerName" Text='<%# (Eval("ContinerName").ToString()) %>' runat="server" ></dnn:Label>
                <br/>
                <dnn:Label ID="lblVazneKhales" Text="وزن ناخالص هر کانتینر پر(کیلوگرم):" runat="server" ></dnn:Label>
                ...
                <br/>
                <dnn:Label ID="lblNoeMalekiyat" Text="نوع مالکیت:" runat="server" ></dnn:Label>
                <dnn:DnnComboBox EmptyMessage="-- انتخاب نماييد --" runat="server" ID="cbolNoeMalekiyat">
                    <Items>
                        <dnn:DnnComboBoxItem runat="server" Text="-- انتخاب نمایید --" Value="-1"/>
    ...
    <div class="dnnFormItem">
        <asp:CheckBox runat="server" Text="امکان استریپ کردن(خالی کردن محمولات از کانتینر قبل از مقصد نهایی) کانتینر وجود دارد" ID="chkIsStrip"/>
    </div>
    ...
    <!-- (در صورتی که COC باشد و سوال استریپ کردن منفی باشد) -->
    <div class="dnnFormItem">
        <asp:CheckBox runat="server" Text="با احتساب هزینه عودت کانتینر خالی به کشتیرانی" ID="chkIsOdateContinereKhali"/>
    </div>
