<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplyToInquiry_ChandVajhiSabok.ascx.cs" Inherits="MyDnn_EHaml.MyDnn_EHaml_Inquiries.ReplyToInquiry_ChandVajhiSabok" %>
...
<div class="ReplyToInquiry-ChandVajhiSabok-Shenasname dnnForm">
    
    <div class="dnnFormItem pasokh-title">
        <dnn:Label Text="شناسنامه استعلام" ID="lblReplyToInquiryChandVajhiSabokShenasnameTitle" runat="server"></dnn:Label>
    </div>
...
<div class="ReplyToInquiry-Dn-Reply-Form dnnForm">
    <div class="dnnFormItem pasokh-title">
