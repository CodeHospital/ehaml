function align_fixed_table_row ($selected_row) {
	var $equivalent_row = $selected_row.parents('.first_coll_fixed_table:first').find('.fixed_table tr:eq(' + $selected_row.index() + ')');

	$equivalent_row.height($selected_row.height());
}
