<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_TonkenCenter.ascx.cs" Inherits="DNNGo.Modules.LayerSlider3D.Setting_TonkenCenter" %>
...
<div id="mo_wrapper" class="validationEngineContainer form_div_<%=ModuleId %>">
    ...
    <div class="mo_breadcrumb clearfix">
      <asp:Label ID="lblEffectName"  runat="server" CssClass="EffectName" Visible="false"></asp:Label>  <asp:Label ID="lblMessage"  runat="server" CssClass="LI_Message"></asp:Label>
    </div>
    <div id="mo_content">
        <div id="contact_tabs">
