<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_ManagerList.ascx.cs" Inherits="DNNGo.Modules.LayerSlider3D.Setting_ManagerList" %>
                    ...
                    <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvArticleList_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LastUser" HeaderText="User" HeaderStyle-Width="50" /> --%>
                             <asp:BoundField DataField="StartTime" HeaderText="Start Time"  HeaderStyle-Width="80" /> 
                            <asp:BoundField DataField="EndTime" HeaderText="End Time" HeaderStyle-Width="80" /> 
