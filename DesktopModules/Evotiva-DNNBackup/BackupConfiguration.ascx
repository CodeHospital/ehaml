<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="BackupConfiguration.ascx.cs"
            Inherits="Evotiva.DNN.Modules.DNNBackup.BackupConfiguration" %>
...
<div style="margin-top: 30px;">
            <evotiva:BreadCrumb runat="server" ID="ctlBreadConfigActions" />
</div>

<p style="margin-top: 30px;">
    <asp:image id="imgReturn"  tabindex="-1" runat="server" imageurl="~/images/lt.gif" enableviewstate="False"/> 
    <asp:LinkButton ID="cmdReturn" ResourceKey="cmdReturn" runat="server" Text="Return" BorderStyle="none" CausesValidation="False"/>
</p>
