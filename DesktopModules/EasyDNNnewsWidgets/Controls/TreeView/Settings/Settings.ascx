	...
	<div class="module_settings">
				...
				<table class="settings_table" cellpadding="0" cellspacing="0">
					<tr class="second">
						...
						<td class="right">
							...
							<asp:CompareValidator ID="cvThemeSelect" resourcekey="cvThemeSelect.ErrorMessage" runat="server" ForeColor="Red" ControlToValidate="ddlTheme" Display="Dynamic" ErrorMessage=" Please select theme." Operator="NotEqual" ValidationGroup="vgCatMenuSettings" ValueToCompare="" />
						</td>
					</tr>
					<tr>
						<td class="left">
		...
		<div class="main_actions">
			<p>
				...
				<asp:CustomValidator ID="cvCategoriesTreeview" resourcekey="cvCategoriesTreeview.ErrorMessage" runat="server" ForeColor="Red" ClientValidationFunction="CategoryClientValidate" Display="Dynamic" Enabled="False" ErrorMessage="Please select at least one category." ValidationGroup="vgCatMenuSettings" />
			</p>
			<div class="buttons">
